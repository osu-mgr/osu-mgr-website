...
blocks:
  - body:
      - content: |
          ...
          NOAA's Index to Marine and Lacustrine Geological Samples has been decommissioned as of May 2025. SESAR is working to maintain this important resource, current database can be viewed here: [https://imlgs.geosamples.org/](https://imlgs.geosamples.org/)

          Additional databases that may be useful include:
