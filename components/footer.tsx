      ...
      <Segment inverted attached style={{ border: 'none' }}>
        <Container><div className='container'>
          <Grid textAlign='center' stackable>
            ...
            <Grid.Column width='3'>
              <Segment inverted compact basic style={{ padding: 0, margin: 'auto' }}>
                <h3>Mailing Address</h3>
                <List inverted>
                  <List.Item as='a' href='https://goo.gl/maps/xf53rxABNqSvXnjE6' rel='noreferrer' target='_blank'>
            ...
            <Grid.Column width='3'>
              <a href='https://goo.gl/maps/hL3SYJaRDU4189CG7' rel='noreferrer' target='_blank'>
                <Image rounded src='nypro.png' style={{ height: '8em', margin: 'auto' }} />
              </a>
            </Grid.Column>
            <Grid.Column width='3'>
              <a href='https://goo.gl/maps/xf53rxABNqSvXnjE6' rel='noreferrer' target='_blank'>
                <Image rounded src='map.png' style={{ height: '8em', margin: 'auto' }} />
              </a>
            </Grid.Column>
          </Grid>
        </div></Container>
