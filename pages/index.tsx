...
import { InlineForm, InlineTextarea, InlineBlocks, BlocksControls, InlineText } from 'react-tinacms-inline';
import Layout from '../components/layout';
import Link from '../components/link';
import PrimaryButton from '../components/primaryButton';
import { Segment, Header, Icon, Message, Grid, Image, Container } from 'semantic-ui-react';

const ColumnBlock: FunctionComponent<{ data: any, index: number }> = ({ data, index }) => {
	const cms = useCMS();
	const block = <>
