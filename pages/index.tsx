...
export const Index: FunctionComponent<{ file: any }> = ({ file }) => {
			...
			<Layout>
					...
					<Grid stackable divided columns='3'>
						<Grid.Column>
							<Link href='request-samples'>
								<Image centered circular size='small' src='request.png' as='a' style={{ display: 'block', cursor: 'pointer' }} />
							</Link>
						...
						<Grid.Column>
							<Link href='facility-history'>
								<Image centered circular size='small' src='collections.png' as='a' style={{ display: 'block', cursor: 'pointer' }} />
							</Link>
						...
						<Grid.Column>
							<Link href='virtual-tour'>
								<Image centered circular size='small' src='facility.png' as='a' style={{ display: 'block', cursor: 'pointer' }} />
							</Link>
				...
				<Segment padded='very' vertical>
					<Grid stackable>
						...
						<Grid.Column width='4'>
							<Image bordered src='education.png'/>
						</Grid.Column>
					</Grid>
				</Segment>
			</Layout>
