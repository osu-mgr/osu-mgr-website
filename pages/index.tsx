...
import { Segment, Header, Icon, Message, Grid, Image, Container, Button } from 'semantic-ui-react';
			...
			<Layout>
				...
				<div className='videoSegment'>
					<Segment vertical inverted textAlign='center' style={{ background: 'none' }}>
						...
						<Header
							as='h3'
							content='Visit our virtual interactive tour.'
							inverted
						/>
					</Segment>
				</div>
